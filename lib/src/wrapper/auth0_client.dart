...
class Auth0Client {
  ...
  Future<void> logoutWithRedirect({String returnTo = ''}) async {
    return await promiseToFuture(_client
        .logoutWithRedirect(interop.RedirectLogoutOptions(returnTo: returnTo)));
  }
